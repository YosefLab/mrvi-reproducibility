...
workflow run_models {
    ...
    scvi_outs = fit_scviv2(adatas_in, false, false, false, false) | get_latent_scviv2
    scvi_adata = scvi_outs.adata

    // Run scviv2 mlp
    scvi_mlp_outs = fit_scviv2_mlp(adatas_in, true, false, false, false) | get_latent_scviv2_mlp
