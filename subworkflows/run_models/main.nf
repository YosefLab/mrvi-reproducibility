...
include {
    fit_and_get_latent_composition_baseline as fit_and_get_latent_composition_scvi;
    fit_and_get_latent_composition_baseline as fit_and_get_latent_composition_pca;
...
workflow run_models {
    ...
    if ( params.runAllModels) {
        ...
        c_scvi_outs=fit_and_get_latent_composition_scvi(adatas_in, "SCVI_clusterkey_subleiden1")
        c_pca_outs=fit_and_get_latent_composition_pca(adatas_in, "PCA_clusterkey_subleiden1")
